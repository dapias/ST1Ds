...
function jacobian(r_and_phi::Vector{Float64}, potential::Function, thermo::Thermostat)
    ...
    J = [0. 1. 0.; fprime(q) friction(thermo, z)/thermo.beta p*difffriction(thermo, z)/thermo.beta; 0. 2.0*p 0.]
...
function flowRK(field::Function, r0::Vector{Float64},dt::Float64, tfinal::Float64, potential::Function, thermo::Thermostat)
...
function lyapunovspectra(field::Function, r::Vector{Float64}, dt::Float64, dtsampling::Float64, nsteps::Int64, potential::Function, thermo::Thermostat)
    ...
    norm3 = Float64[]
    for i in 1:nsteps
        pos = flowRK(field, r, dt, dtsampling, potential, thermo) 
        r[1:3] = pos[1:3]
